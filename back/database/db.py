...
def _seed_golfers():
    ...
    golfers = [
        ...
        ("9496",  "Ludvig Aberg",            10100, 2,  "SWE"),
        ("4362",  "Russell Henley",           9800, 3,  "USA"),
        ("4564",  "Robert MacIntyre",         9900, 4,  "SCO"),
        ("5467",  "Si Woo Kim",               9600, 5,  "KOR"),
        ("3802",  "Jordan Spieth",            9500, 6,  "USA"),
        ...
        ("5022",  "Sahith Theegala",          7400, 29, "USA"),
