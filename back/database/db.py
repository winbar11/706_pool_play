...
GOLFER_SEED_DATA = [
    ...
    # (espn_id, name, salary, world_rank, country)
        ...
        ("5215013", "Jackson Koivun (a)",           6300,  145, "USA"),
        ...
        ("686",     "Miles Russell (a)",            5500,  999, "USA"),
        ...
        ("5210226", "Preston Stout (a)",            5300,  999, "USA"),
        ("5344766", "Jackson Herrington (a)",       5300,  999, "USA"),
        ("5293232",  "Ethan Fang (a)",              5300,  999, "USA"),
        ("4884239", "Filippo Celli",                5300,  999, "ITA"),
        ("5289813", "Bryan Lee (a)",                5300,  999, "USA"),
        ("5027437", "Cooper Dossey",                5200,  999, "USA"),
        ("5203535", "Jackson Van Paris",            5200,  999, "USA"),
        ("5343786", "Hamilton Coleman (a)",         5200,  999, "USA"),
        ("5362517", "Ryder Cowan (a)",              5200,  999, "USA"),
        ("5362520", "Chase Kyes (a)",               5200,  999, "USA"),
        ("5362521", "Eric Lee (a)",                 5200,  999, "USA"),
        ("5277550", "Robbie Higgins",               5200,  999, "USA"),
        ("4425905", "Spencer Tibbits",              5200,  999, "USA"),
        ("5362518", "Marek Fleming (a)",            5100,  999, "USA"),
        ("5362519", "Vaughn Harber (a)",            5100,  999, "USA"),
        ("10994",   "Manav Shah",                   5100,  999, "USA"),
        ("2201886", "Brandon Holtz (a)",            5100,  999, "USA"),
        ("5289811", "Mason Howell (a)",             5100,  999, "USA"),
        ...
        ("5362522", "Logan Reilly (a)",             5000,  999, "USA"),
        ("5362523", "Matthew Robles (a)",           5000,  999, "USA"),
        ("1067",    "J.B. Holmes",                  5000,  999, "USA"),
        ("4699297", "Ryuichi Oiwa",                 5000,  999, "JPN"),
        ("5326067", "Jake Peacock",                 5000,  999, "USA"),
        ("5272338", "Giuseppe Puebla (a)",          5000,  999, "USA"),
        ("5344763", "Mateo Pulcini (a)",            5000,  999, "ARG"),
        ("5327840", "Greyson Leach",                5000,  999, "USA"),
        ("5360549", "Jackson Ormond (a)",           5000,  999, "USA"),
        ("5362524", "Arni Sveinsson (a)",           5000,  999, "ISL"),
]
